...
- login Google e sincronizacao em nuvem via Firebase, quando configurado.
...
Para ativar login Google e dados na nuvem, siga o passo a passo em `FIREBASE_SETUP.md`.
